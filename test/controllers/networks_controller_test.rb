...
class NetworksControllerTest < ActionController::TestCase
  ...
  test "should create network" do
    assert_difference('Network.count') do
      post :create, network: { cidr_address: @network.cidr_address, domain: @network.domain, location: @network.location, name: @network.name, private: @network.private, vlan: @network.vlan }
    end
  ...
  test "should update network" do
    patch :update, id: @network, network: { cidr_address: @network.cidr_address, domain: @network.domain, location: @network.location, name: @network.name, private: @network.private, vlan: @network.vlan }
    assert_redirected_to network_path(assigns(:network))
  end
